...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form action="{{ url('profile-anggota/store' . (!empty($id) ? '/' . $id : '')) }}" method="post">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="username" type="text" value="{{ _val($user->username,null) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3 w-full">
                            <div class="flex justify-end text-end mb-2">
                                <button class="btn btn-primary text-dark" type="submit">Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
